...
entre 5000 e 7000 ele receberá um aumento de 7%;mais de 7000 ele receberá
10%.
...
alert("Bem vindo a empresa maravilha! ")
let relatorioFuncionario = "";
let quantidadeDeFuncionario = Number(prompt(`Digite a quantidade de funcionarios`));
let chamada

for(chamada = 1; chamada <= quantidadeDeFuncionario; chamada){

    let nome, salario, cargo, tempo

    nome = prompt("nome do funcionario");
    salario = prompt("Digite o seu salario");
    ...
    if(tempo < 3){
        if(salario < 1999){
            salario*= 1.02
            alert(`Seu salario eh: ` + salario.toFixed(2))
